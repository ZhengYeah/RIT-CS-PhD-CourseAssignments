...
# # test omp_float
# import hw3tensor_omp_float
# start = time.time()
# tensor_x = hw3tensor_omp_float.Tensor(xdims,xidx,xval)
# tensor_y = hw3tensor_omp_float.Tensor(ydims,yidx,yval)
# tensor_z = hw3tensor_omp_float.Tensor(zdims,zidx,zval)
# tensor_label = hw3tensor_omp_float.Tensor(ldims,lidx,lval)
# for i in range(EPOCH):
#   print(i)
#   h1 = tensor_x.matmul(tensor_y) # N*P
#   h2 = h1.relu() # N*P
...
# # test omp_cuda
# import hw3tensor_omp_cuda_test
# start = time.time()
# tensor_x = hw3tensor_omp_cuda_test.Tensor(xdims,xidx,xval)
# tensor_y = hw3tensor_omp_cuda_test.Tensor(ydims,yidx,yval)
# tensor_z = hw3tensor_omp_cuda_test.Tensor(zdims,zidx,zval)
# tensor_label = hw3tensor_omp_cuda_test.Tensor(ldims,lidx,lval)
# for i in range(EPOCH):
#   print(i)
#   h1 = tensor_x.matmul(tensor_y) # N*P
#   h2 = h1.relu() # N*P
