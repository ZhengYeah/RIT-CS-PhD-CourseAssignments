for alpha = [0.05]
    ...
    for k = 1:1:length(mu)
        for N = [10]
            ...
            for i = 1:10000
                X = sample_normal(N, sigma(k), mu(k));
            ...
            fprintf("Normal Dist. with mu = %1.3f, mean epsilon: %1.3f, normal missed: %1.6f \n", mu(k), mean_epsilon, 1 - normal_test_in / 10000);
            for i = 1:1:10
